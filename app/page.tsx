...
export default async function HomePage() {
  // Try to fetch home page from WordPress, fallback to static content
  const page = await getPageBySlug('home')

  // If WordPress page exists, use it; otherwise use fallback content
  const heroHeading = page?.acfFields?.heroHeading || 'Landscaping Digital Marketing'
      ...
      <div className="container">
        {content ? (
          ...
          <div className="content">
            ...
            <p>
              We offer comprehensive digital marketing solutions specifically designed for landscaping companies. 
              Our services work together to help you get found online, generate qualified leads, and book more jobs.
            </p>

            <div className="service-grid">
              <div className="service-card">
                <h3>SEO</h3>
                <p>Get found on Google when homeowners search for landscaping services. Long-term visibility that generates free traffic month after month.</p>
                <Link href="/landscaping-seo">Learn More →</Link>
              </div>

              <div className="service-card">
                <h3>Paid Advertising</h3>
                <p>Drive immediate leads with targeted Google Ads campaigns. Start getting phone calls within days of launch.</p>
                <Link href="/landscaping-ads">Learn More →</Link>
              </div>

              <div className="service-card">
                <h3>Website Development</h3>
                <p>Professional websites that showcase your work, load fast, and convert visitors into customers. Mobile-responsive and SEO-optimized.</p>
            ...
            <p>
              Landscaping digital marketing is the strategic use of online channels to reach homeowners 
              and commercial property managers who need landscaping services. Unlike generic marketing 
              agencies, we specialize exclusively in the landscaping industry. We understand your seasonal 
              cycles, your local competition, and what makes customers choose one landscaper over another.
            </p>

            <h2>Why Landscapers Need Digital Marketing</h2>
            <p>
              Most landscaping companies rely on word-of-mouth and referrals. While those are valuable, 
              they limit your growth. Here's what happens when you add landscaping digital marketing:
            </p>
            ...
            <p>
              Our approach combines search engine optimization (SEO), paid advertising, website optimization, 
              and content marketing to create a complete system that generates leads year-round. Each service 
              works together to maximize your online visibility and lead generation.
            </p>

            <h2>What Makes Us Different from Generic Marketing Agencies</h2>
            <p>
              Most marketing agencies work with dozens of industries. We focus exclusively on landscaping companies. 
