      ...
      <div className="container">
        <div className="content">
          ...
          <div className="service-grid">
            <div className="service-card">
              ...
              <p>
                ...
                services. Long-term visibility that generates free traffic month
                after month.
              </p>
            ...
            <div className="service-card">
              ...
              <p>
                Drive immediate leads with targeted Google Ads campaigns. Start
                getting phone calls within days of launch.
              </p>
          ...
          <ul className="benefits-list">
            ...
            <li>
              <strong>Reach customers actively searching:</strong> Show up when
              homeowners type &quot;landscaper near me&quot; or &quot;lawn care
              services&quot;
            </li>
            <li>
              <strong>Compete with larger companies:</strong> Level the playing
              field against big franchises with bigger ad budgets
            </li>
            <li>
          ...
          <p>
            ...
            advertising, website optimization, and content marketing to create a
            complete system that generates leads year-round. Each service works
            together to maximize your online visibility and lead generation.
          </p>
          ...
          <ul className="benefits-list">
            ...
            <li>
              We know which keywords actually convert (not just ones that sound
              good)
            </li>
            <li>
